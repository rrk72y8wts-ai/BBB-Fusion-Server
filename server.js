...
const SERVER_NAME = "BBB Fusion Server";
const APP_ID = "BBB";
...
app.post("/room/register", (req, res) => {
    ...
    console.log(
        `📱 [BBB] Watch registered: ${watchID} in room ${room}`
    );
...
app.post("/room/bump", (req, res) => {
    ...
    if (!roomData.pendingBump) {
        ...
        console.log(
            `👊 [BBB] First bump: ${watchID} (${element})`
        );
    ...
    console.log(
        `👊 [BBB] Second bump: ${watchID} (${element})`
    );
...
app.post("/room/sound-finished", (req, res) => {
    ...
    if (bothSoundsFinished) {
        ...
        console.log(
            "🔥 [BBB] BOTH SOUNDS FINISHED"
        );

        console.log(
            "🔥 [BBB] FUSION_EXECUTE READY"
        );
    }
...
app.post("/room/fusion-complete", (req, res) => {
    ...
    if (bothCompleted) {
        ...
        console.log(
            "🎉 [BBB] BOTH WATCHES COMPLETED FUSION"
        );
...
app.post("/room/event", (req, res) => {
    ...
    console.log(
        `📡 [BBB] Generic event from ${watchID}:`,
        event
    );
...
setInterval(() => {
    ...
    for (
        ...
        if (
            ...
            console.log(
                `🧹 [BBB] Removed inactive room: ${roomCode}`
            );
        }
    }
